...
public class AnnonceDetailActivity extends AppCompatActivity   {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(AnnonceDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(AnnonceDetailFragment.ARG_ITEM_ID));
            AnnonceDetailFragment fragment = new AnnonceDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.annonce_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            NavUtils.navigateUpTo(this, new Intent(this, AnnonceListActivity.class));
            return true;
        }
