...
import com.wasp.amanda.projet_mobile.dummy.DummyContent;
...
public class AnnonceDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            if (appBarLayout != null) {
                appBarLayout.setTitle(mItem.region);
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.annonce_detail)).setText(mItem.detail);
        }
