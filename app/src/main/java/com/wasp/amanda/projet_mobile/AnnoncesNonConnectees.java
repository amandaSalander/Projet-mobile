 ...
 */
public class AnnoncesNonConnectees extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AnnoncesNonConnectees.this, FilterActivity.class);
                startActivity(intent);
                Toast.makeText(AnnoncesNonConnectees.this, "FILTRE !!!! XD",
