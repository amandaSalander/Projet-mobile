...
import com.wasp.amanda.projet_mobile.AnnonceDetailActivity;
import com.wasp.amanda.projet_mobile.AnnonceDetailFragment;
import com.wasp.amanda.projet_mobile.annonces_dummy.Annonces;
import com.wasp.amanda.projet_mobile.services.AnnonceService;
import com.wasp.amanda.projet_mobile.userActions.CreateShortAnnonceActivity;
 ...
 */
public class PublishAnnoncesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
...
//        getMenuInflater().inflate(R.menu.annoncement_connected, menu);
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            final Boolean connecter = getIntent().getBooleanExtra("connecter",false);
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putBoolean("connecter", connecter);
...
//                        arguments.put
                        ...
                        intent.putExtra("connecter", connecter);
